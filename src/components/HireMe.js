    ...
    return (
        ...
        ">
            <div className="w-48 h-auto flex items-center justify-center relative">
                ...
                <Link href='mailto:huynhanhkiet2222@gmail.com' className="flex items-center justify-center absolute left-1/2 top-1/2 -translate-x-1/2 -translate-x-1/2 -translate-y-1/2 bg-dark
