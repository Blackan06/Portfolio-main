          ...
          <div className="flex items-center justify-between w-full">
              ...
              <div className='w-1/2 flex flex-col items-center self-center'>
                ...
                <div className='flex items-center self-start mt-2'>
                  ...
                  border-solid border-transparent hover:border dark:bg-light dark:text-dark hover:dark:bg-dark hover:dark:text-light hover:dark:border-light' download={true}>
                    Resume <LinkArrow className={"w-6 ml-1"} /></Link>
                  <Link href='mailto:huynhanhkiet2222@gmail.com' target={"_blank"}
